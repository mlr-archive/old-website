...
We also implemented common multilabel performance measures. Here is a list with [available multilabel performance measures](https://mlr-org.github.io/mlr/devel/html/measures/index.html#multilabel-classification):
...
### 4) Resampling
Here I'll show you how to use resampling methods in the multilabel setting. Resampling methods are key for assessing the performance of a learning algorithm. To read more about resampling, see the page on our [tutorial](https://mlr-org.github.io/mlr/devel/html/resample/index.html).
...
Many methods, which are available in mlr, like [preprocessing](https://mlr-org.github.io/mlr/devel/html/preproc/index.html), [tuning](https://mlr-org.github.io/mlr/devel/html/tune/index.html) or [benchmark experiments](https://mlr-org.github.io/mlr/devel/html/benchmark_experiments/index.html) can also be used for multilabel datasets and the good thing here is: the syntax stays the same!
