...
## 1 setosa   0.4995532   0.1000000
## 2 setosa   0.4470390   0.3666667
## 3 setosa   0.3827077   0.6333333
## 4 setosa   0.3238006   0.9000000
## 5 setosa   0.2545992   1.1666667
## 6 setosa   0.1822693   1.4333333
{% endhighlight %}
...
## 1 setosa   0.4995532   0.1000000           NA
## 2 setosa   0.4470390   0.3666667           NA
## 3 setosa   0.3827077   0.6333333           NA
## 4 setosa   0.3238006   0.9000000           NA
## 5 setosa   0.2545992   1.1666667           NA
## 6 setosa   0.1822693   1.4333333           NA
{% endhighlight %}
...
{% highlight text %}
##        Class Probability Petal.Width Petal.Length
## 55 virginica   0.1796368          NA     3.622222
## 56 virginica   0.2864038          NA     4.277778
## 57 virginica   0.4084632          NA     4.933333
## 58 virginica   0.5577714          NA     5.588889
## 59 virginica   0.6775709          NA     6.244444
## 60 virginica   0.6989025          NA     6.900000
{% endhighlight %}
...
## Individual: FALSE
##    Class Probability Petal.Width Petal.Length
## 1 setosa   0.6762439   0.1000000            1
## 2 setosa   0.6721171   0.3666667            1
## 3 setosa   0.6371599   0.6333333            1
## 4 setosa   0.5667907   0.9000000            1
## 5 setosa   0.4658882   1.1666667            1
## 6 setosa   0.3675008   1.4333333            1
{% endhighlight %}
...
{% highlight text %}
## Error in checkClass(x, classes, ordered): object 'fit.regr' not found
{% endhighlight %}
...
{% highlight text %}
## Error in eval(expr, envir, enclos): object 'pd.ci' not found
{% endhighlight %}
...
{% highlight text %}
## Error in checkClass(x, classes, ordered): object 'pd.ci' not found
{% endhighlight %}
...
## 1 31.05083  1.730000   NA 27.51772 34.58395
## 2 26.11077  5.756667   NA 23.51764 28.70389
## 3 23.40704  9.783333   NA 21.30862 25.50546
## 4 22.03407 13.810000   NA 20.31004 23.75810
## 5 20.42697 17.836667   NA 18.73239 22.12155
## 6 19.80303 21.863333   NA 17.98714 21.61893
{% endhighlight %}
...
{% highlight text %}
##        medv lstat     crim    lower    upper
## 15 21.79994    NA 39.54849 19.52598 24.07390
## 16 21.77393    NA 49.43403 19.49611 24.05175
## 17 21.75108    NA 59.31957 19.46372 24.03845
## 18 21.74101    NA 69.20512 19.44716 24.03486
## 19 21.74436    NA 79.09066 19.45101 24.03771
## 20 21.74478    NA 88.97620 19.45151 24.03805
{% endhighlight %}
...
{% highlight text %}
## Error in eval(expr, envir, enclos): object 'pd.ind.regr' not found
{% endhighlight %}
...
{% highlight text %}
## Error in checkClass(x, classes, ordered): object 'pd.ind.regr' not found
{% endhighlight %}
...
## 1 setosa   0.9786562            1 1.setosa
## 2 setosa   0.9713711            1 2.setosa
## 3 setosa   0.9790045            1 3.setosa
## 4 setosa   0.9767924            1 4.setosa
## 5 setosa   0.9777691            1 5.setosa
## 6 setosa   0.9722207            1 6.setosa
{% endhighlight %}
...
{% highlight text %}
## Error in head(pd.regr.der.ind$data): object 'pd.regr.der.ind' not found
{% endhighlight %}
...
{% highlight text %}
## Error in checkClass(x, classes, ordered): object 'pd.regr.der.ind' not found
{% endhighlight %}
...
## 1 setosa  0.02884466         0.1 1.setosa
## 2 setosa  0.02047014         0.1 2.setosa
## 3 setosa  0.01914757         0.1 3.setosa
## 4 setosa  0.01794767         0.1 4.setosa
## 5 setosa  0.03016593         0.1 5.setosa
## 6 setosa  0.04477821         0.1 6.setosa
{% endhighlight %}
...
##   effect     medv     lstat
## 1  lstat 24.91494  1.730000
## 2  lstat 23.75716  5.756667
## 3  lstat 22.34899  9.783333
## 4  lstat 20.69156 13.810000
## 5  lstat 19.59154 17.836667
## 6  lstat 19.00221 21.863333
{% endhighlight %}
...
## 2 23.75716  5.756667
## 3 22.34899  9.783333
## 4 20.69156 13.810000
## 5 19.59154 17.836667
## 6 19.00221 21.863333
{% endhighlight %}
...
## 1 crim:lstat -22.68556  0.006320  1.73  NA
## 2 crim:lstat -23.21832  9.891862  1.73  NA
## 3 crim:lstat -24.76173 19.777404  1.73  NA
## 4 crim:lstat -26.39665 29.662947  1.73  NA
## 5 crim:lstat -27.55616 39.548489  1.73  NA
## 6 crim:lstat -28.28518 49.434031  1.73  NA
{% endhighlight %}
