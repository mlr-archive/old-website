...
* an API to add and access custom search spaces to the [mlrHyperopt Database](http://mlrhyperopt.jakob-r.de/parconfigs).
...
This will minimize the _missclassification rate_.
...
rr = makeResampleDesc("CV", iters = 10, stratify = TRUE)
