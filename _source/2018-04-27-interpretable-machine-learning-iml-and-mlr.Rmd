...
Fortunately there are many methods that can make the any machine learning  model interpretable. 
...
`Predictor` works best with mlr models (`WrappedModel`-class), it is also possible to use models from other packages.
