...
saveRDS(results, file = "2017-03-22-Parallel_benchmarking_with_OpenML_and_mlr.rds")
```
```{r, echo=FALSE, eval=TRUE}
results = readRDS(file = "2017-03-22-Parallel_benchmarking_with_OpenML_and_mlr.rds")
```
```{r, eval=TRUE}
results
```
