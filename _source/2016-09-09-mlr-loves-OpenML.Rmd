...
from package kernlab, which is itegrated in mlr ("classif.ksvm").

![](../images/openml_screenshot_study.png) 
...
The runs are now on the website and can be found using the tag or via the
[study homepage]()

% TODO: change eval to TRUE
```{r, eval=FALSE} 
